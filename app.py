...
# ADMIN uchun barcha tablarni ochish (Reja ham qo'shildi)
if role == "admin":
            ...
            with col_alerts:
                ...
                if not df_reja.empty:
                    ...
                    for p_idx, plan in active_plans.iterrows():
                        ...
                        wh_qty_model = 0
                        if not df_komplektlar.empty:
                            m_containers = df_komplektlar[(df_komplektlar["Model"] == p_model) & (df_komplektlar["Optsiya"] == p_opt) & (df_komplektlar["Hozirgi Joylashuv"].isin(["KD Omborda", "Ishlab chiqarish liniyasida"])]
